...
//}
//
//auto DrawModel(Shader* shader,unsigned int& texture,Model* Model,Camera camera){
//    shader->use();
...
//    shader->setFloat("refractratio", 1.00f/2.50f);
...
//    
//    Shader* modelshader=new Shader("/Users/sherlock/Documents/Code/OpenGLdemo/OpenGLdemo/Advanced/Cubemaps/nanosuit.vs","/Users/sherlock/Documents/Code/OpenGLdemo/OpenGLdemo/Advanced/Cubemaps/nanosuit.fs");
//
//    Model* Nanosuit=new Model("/Users/sherlock/Documents/Code/OpenGLdemo/OpenGLdemo/resource/models/nanosuit_reflection/nanosuit.obj");
//
...
//
//    float refractratio=1.00f/1.02f;
//    
...
//    bool mode_default=true;
//    bool mode_reflect=false;
//    bool mode_refract=false;
//
//
...
////        GLint modelocation=glGetUniformLocation(modelshader->ID,"mode");
////        GLint modevalue;
////        glGetUniformiv(modelshader->ID,modelocation,&modevalue);
////        cout<<"modevalue:"<<modevalue<<endl;
//        ImGui::End();
//
////        float depthValue;
////        int viewport[4];
...
//        DrawModel(modelshader, cubemapTexture, Nanosuit, camera);
//
