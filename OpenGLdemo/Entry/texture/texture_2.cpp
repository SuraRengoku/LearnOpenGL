...
//
//    Shader *shader=new Shader("/Users/sherlock/Documents/Code/OpenGLdemo/OpenGLdemo/Entry/texture/shader_0.vs","/Users/sherlock/Documents/Code/OpenGLdemo/OpenGLdemo/Entry/texture/shader_2.fs");
//
...
//
//    int updown;//纹理2能见度调节
//    float mixweight=0.5;//能见度
//
//    while (!glfwWindowShouldClose(window)) {
//        processInput(window);
//        updown=processInputUpDown(window);
//        mixweight+=updown*0.01;
//        if(mixweight>1.0){
//            mixweight=1.0;
//        }else if(mixweight<0){
//            mixweight=0.0;
...
//
//        shader->use();
//        shader->setFloat("weight", mixweight);
//        glBindVertexArray(VAO);
